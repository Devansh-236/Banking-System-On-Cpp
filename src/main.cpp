...
int main()
{
    ...
    cout << "\n=== Testing New Functions ===" << endl;

    // Test system statistics
    cout << "Total Transactions: " << txnManager.getTotalTransactionCount() << endl;
    cout << "Total System Volume: $" << fixed << setprecision(2)
         << txnManager.getTotalSystemVolume() << endl;

    // Test display functions
    cout << "\n--- Deposits ---" << endl;
    txnManager.displayTransactionsByType(TransactionType::DEPOSIT, 5);

    cout << "\n--- Daily Summary ---" << endl;
    txnManager.displayDailyTransactionSummary(txnManager.getCurrentDate());

    // Test validation
    cout << "\n--- Validation Tests ---" << endl;
    cout << "Valid ID test: " << (txnManager.isValidTransactionId("TXN2025-07-001") ? "PASS" : "FAIL") << endl;
    cout << "Invalid ID test: " << (txnManager.isValidTransactionId("INVALID123") ? "FAIL" : "PASS") << endl;
